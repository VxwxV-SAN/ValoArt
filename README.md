...
- Si has descargado el código previamente, lamento que esté un poco desordenado. Con setup puedes convertir el archivo .py en un ejecutable. Recuerda que "data.json", "logo.ico" y "cuack.mp3" deben estar dentro de la carpeta del ejecutable para que el código funcione.
